# Visor cartográfico COVID-19 CYL Versión desktop
Visor cartográfico sobre los casos de coronavirus en Castilla y León en tiempo real. En el visor se ha incluido un dashboard donde se muestran los casos totales diarios, defunciones totales y altas totales de la comunidad. Asimismo en la parte inferior se ha incluido una tabla donde se muestra los datos a detalle de nivel provincial. El visor está optimizado para su visualización en ordenadores. Los lenguaje de programación utilizado para este visor han sido HTML, CSS y JavaScript.
